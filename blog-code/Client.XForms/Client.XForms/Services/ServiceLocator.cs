...
namespace Client.XForms.Services
{
    public sealed class ServiceLocator
    {
        ...
        /// <summary>
        /// Register a new Service with the service locator
        /// </summary>
        ...
        /// <summary>
        /// Resolves a service request and returns the implementation.  Note that this assumes
        /// the key used to register the object is of the appropriate type or this method will
